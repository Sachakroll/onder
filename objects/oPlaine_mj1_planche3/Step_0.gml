if moving == true && cy != -1
{
	sprite_index = sPlaine_mj1_planche3_mov
	...
	if cx < old_cx
	{
		if oPlaine_mj1.puzzle[cy][cx] == 1 || oPlaine_mj1.puzzle[cy+1][cx] == 1
		{
			...
			if old_cx == 12 || old_cx == 13
			{
				ejection = 1
				oPlaine_mj1.puzzle[cy][old_cx] = 0
				oPlaine_mj1.puzzle[cy+1][old_cx] = 0
			}
		...
		{
			oPlaine_mj1.puzzle[cy][cx+1] = 0
			oPlaine_mj1.puzzle[cy+1][cx+2] = 0
			oPlaine_mj1.puzzle[cy][cx] = 1
			oPlaine_mj1.puzzle[cy+1][cx] = 1
		}
	...
	if keyboard_check_pressed(vk_down) && cy < 2
	{
		if cx > 12
		{
			cy++
		...
		else if oPlaine_mj1.puzzle[cy+2][cx] == 0 && oPlaine_mj1.puzzle[cy+2][cx+1] == 0
		{
			oPlaine_mj1.puzzle[cy][cx] = 0
			oPlaine_mj1.puzzle[cy+1][cx+1] = 0
			cy++
			y += 7
			oPlaine_mj1.puzzle[cy+1][cx] = 1
			oPlaine_mj1.puzzle[cy+1][cx+1] = 1
		}
	}
	...
	if keyboard_check_pressed(vk_up) && cy > 0
	{
		...
		else if oPlaine_mj1.puzzle[cy-1][cx] == 0 && oPlaine_mj1.puzzle[cy][cx+1] == 0
		{
			oPlaine_mj1.puzzle[cy+1][cx] = 0
			oPlaine_mj1.puzzle[cy+1][cx+1] = 0
			cy--
			y -= 7
			oPlaine_mj1.puzzle[cy][cx] = 1
...
{
	sprite_index = sPlaine_mj1_planche3_pos
}
...
if ejection > 0
{
	...
	if ejection > 8
	{
		sprite_index = sPlaine_mj1_planche3_ej
		image_angle += 20
		x+=2
		y-=2
	}
